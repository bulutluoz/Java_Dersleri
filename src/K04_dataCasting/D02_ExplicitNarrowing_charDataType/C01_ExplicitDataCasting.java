...
public class C01_ExplicitDataCasting {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         atama yapmak isterseniz Java sorumluluk almanizi ister,
         sorumluluk almak icin esitligin saginda
         () icerisinde cevirmek istedigimiz data turunu yazariz
